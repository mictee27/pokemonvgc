...
export const LEGAL_POKEMON: PokemonSpecies[] = [
  ...
  { id: 'pecharunt', name: 'Pecharunt', types: ['Poison', 'Ghost'], abilities: ['Poison Puppeteer'], spriteKey: 'pechorunt' },
  { id: 'scream-tail', name: 'Scream Tail', types: ['Fairy', 'Psychic'], abilities: ['Quark Drive'], spriteKey: 'screamtail' },
  { id: 'bute-bonnet', name: 'Brute Bonnet', types: ['Grass', 'Dark'], abilities: ['Protosynthesis'], spriteKey: 'brutebonnet' },
